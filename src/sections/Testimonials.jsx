...
const Testimonials = () => {
  ...
  return (
    <section className="relative z-2 py-24 md:py-24 md:py-28 lg:py-40">
      <div className="container block lg:flex">
        ...
        <div className="testimonial_inner-after testimonial_inner-before relative -my-12 -mr-3 flex items-start max-lg:static max-md:block">
